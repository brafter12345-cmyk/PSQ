...
const rmRows = [
  ...
  ["FIN-7", "Supply-chain wiring into RSI / financial impact / remediation", "Done (2026-05-27)", "All 6 supply-chain checkers wired into RansomwareIndex factors, FinancialImpactCalculator (vulnerability uplift cap +0.15 + catastrophe tail K_TAIL_SC=1.00, shortfall cap 0.20), and 6 new REMEDIATION_MAP rows. Empirically calibrated against Verizon DBIR 2025 (third-party doubled to 30% of breaches), IBM CoDB 2024 (267-day SC dwell vs 204-day baseline), Mandiant M-Trends 2025, Patchstack 2024, CISA BOD 18-01, Sophos State of Ransomware SA 2024. SUPPLY_CHAIN_CAP = 0.22 raw RSI (vs RDP single signal +0.25) keeps supply-chain secondary to primary access vectors. Verification: tooling/verify_supply_chain_financial_wiring.py (30/30 PASS)."],
